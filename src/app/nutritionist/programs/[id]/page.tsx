...
export default function NutritionistProgramDetailPage({
  ...
  const category = (program.category as ProgramCategory as 'Diet' | 'Consultation') || 'Diet'
  const meta = CATEGORY_META[category] || CATEGORY_META.Diet
  ...
  return (
    <div className="space-y-4 sm:space-y-5 pb-24 lg:pb-8">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 p-5 sm:p-6 flex flex-col">
            ...
            <div className="mt-auto flex gap-2">
              <button
                onClick={() =>
                  router.push(`/nutritionist/programs/new?edit=${program.id}&category=${category}`)
                }
      ...
      {program.videoUrls && program.videoUrls.length > 0 && (
        <Section title={`${t('mealRecipeVideos')} · ${program.videoUrls.length}`}>
