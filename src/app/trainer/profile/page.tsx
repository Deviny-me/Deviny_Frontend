    ...
    <>
      <div className="space-y-3 pb-24">
        ...
        <div className="overflow-hidden rounded-none sm:rounded-2xl">
          {/* Banner */}
          <div className="relative h-28 sm:h-36 bg-gradient-to-br from-[#d4722a] to-[#b85e1e] overflow-hidden">
            {trainer.bannerUrl && (
              <img
          ...
          <div className="bg-surface-1 border-x-0 sm:border sm:border-t-0 sm:border-border-subtle rounded-b-none sm:rounded-b-2xl px-4 pb-4 sm:px-6 sm:pb-5">
            ...
            <div className="-mt-10 sm:-mt-14 flex items-end justify-between mb-3">
              <div className="relative z-10">
                {trainer.avatarUrl ? (
                  ...
                  <div className="h-20 w-20 sm:h-28 sm:w-28 rounded-full ring-4 ring-background shadow-xl bg-gradient-to-br from-[#d4722a] to-[#b85e1e] flex items-center justify-center">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-[#d4722a]/10 text-[#d4722a] ring-1 ring-inset ring-[#d4722a]/20">
                <Briefcase className="w-3 h-3" />
                {isNutritionist ? t('personalNutritionist') : t('personalTrainer')}
              </span>
            ...
            <div className="grid grid-cols-4 gap-1.5 sm:gap-2">
              {([
                ...
                <div
                  key={label}
                  className="group flex flex-col items-center justify-center rounded-xl py-2.5 px-1 bg-surface-2/60 dark:bg-surface-2/40 ring-1 ring-inset ring-border-subtle hover:bg-[#d4722a]/10 hover:ring-[#d4722a]/25 transition-[background-color,box-shadow] duration-200 ease-out-expo"
                >
                  <span className="text-base sm:text-lg font-bold text-foreground group-hover:text-[#d4722a] transition-colors tabular-nums leading-none">
        ...
        {activeTab === 'reviews' && (
          <ProfileReviewsTab
            ...
            accentPrimary="#d4722a"
            accentSecondary="#b85e1e"
          />
        )}
