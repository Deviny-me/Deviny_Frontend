      ...
      <div className="space-y-4 pb-6">
        ...
        <div className="text-center py-12 bg-surface-3 rounded-xl border border-border">
          ...
          <button
            ...
            className="mt-4 px-6 py-2 bg-gradient-to-r from-[#d4722a] to-[#b85e1e] text-white text-sm font-semibold rounded-lg hover:opacity-90 transition-opacity"
          >
            {tc('back')}
          </button>
        </div>
          ...
          <span
            className={`px-3 py-1 text-xs font-medium rounded-full backdrop-blur-sm border text-white flex items-center gap-1.5 ${
              program.category === 'Training'
                ? 'bg-[#d4722a]/70 border-[#d4722a]/40'
                : program.category === 'Diet'
                ? 'bg-green-600/70 border-green-500/40'
                : 'bg-violet-600/70 border-violet-500/40'
            }`}
          >
            {program.category === 'Training' ? (
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2 flex-wrap min-w-0">
              <span className="flex items-center gap-1.5 text-white/90 text-sm shrink-0">
                ...
                <span className="text-white/50 text-xs">({program.totalReviews ?? 0})</span>
              </span>
              <span className="text-white/30 text-sm">·</span>
              <span className="flex items-center gap-1.5 text-white/70 text-sm shrink-0">
                <Users className="w-4 h-4" />
                <span>{program.totalPurchases ?? 0}</span>
              </span>
